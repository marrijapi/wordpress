...
add_action('woocommerce_after_add_to_cart_form', 'dodaj_pisca');
function dodaj_pisca()
{
	echo do_shortcode('[acf field="pisci"]');
}

add_filter('gettext', 'promeni_text', 10, 3);

function promeni_text($new_text, $related_text, $source)
{
     if ($related_text === 'Product' && is_page(17)) {
